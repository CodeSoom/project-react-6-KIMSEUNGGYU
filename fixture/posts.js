const posts = [
  {
    ...
    contents: 'git tag 알고 쓰자 git tag 명령어를 자주 사용해서 해당 내용을 간단하게 정리하고자 한다 생성 git tag -a v1.0.0 -m react todo list 기본 템플릿 -a 옵션은 Annotated 태그를 나타냄 Annotated 태그를 만든 사람, 이메일, 날짜, 메시지를 저장할 수 있음',
    tags: ['git'],
